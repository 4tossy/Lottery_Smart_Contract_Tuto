...
contract('Lottery', function([deployer, user1, user2]){
    ...
    describe('Distribute', function () {
        describe('When the answer is checkable', function () {
            it('should give the user the pot when the answer matches', async () => {
                //두 글자 다 맞았을 때
                await lottery.setAnswerForTest('0xab6f17fe907d0cc908d086ba8275cbedf5033940ab7b4b4760bf81d5082a9b06', {from:deployer})
            ...
            it('should get the eth of user the answer does not mathch at all', async () => {
                // 다 틀렸을 때
                await lottery.setAnswerForTest('0xab6f17fe907d0cc908d086ba8275cbedf5033940ab7b4b4760bf81d5082a9b06', {from:deployer})
    ...
    describe('isMatch', function () {
        let blockHash = '0xab6f17fe907d0cc908d086ba8275cbedf5033940ab7b4b4760bf81d5082a9b06'
